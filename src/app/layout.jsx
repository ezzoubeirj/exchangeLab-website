...
const PIXEL_ID = '371485473841753';
...
export default function RootLayout({ children }) {
    return (
          <>
            ...
            {/* Floating WhatsApp button - fires Contact event on click */}
                <a
                          ...
                          className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white rounded-full p-4 shadow-lg transition-all duration-300 hover:opacity-100 hover:scale-110 hover:shadow-xl"
                        >
